    ...
    >
      <div className="mx-auto max-w-[88rem] px-4 sm:px-6">
        ...
        >
          ...
          >
              <span 
  className="grid h-9 w-9 place-items-center rounded-full text-white text-xs font-bold transition-all duration-500 hover:rotate-12 hover:shadow-[0_0_15px_rgba(226,98,21,0.4)]"
  style={{ background: 'linear-gradient(135deg, #e26215, #000000)' }}
>
  {site.brand.mark}
</span>
