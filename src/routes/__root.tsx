...
// Standard TanStack Start asset import
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <Link
          to="/"
          className="mt-8 inline-flex items-center justify-center rounded-full bg-foreground px-5 py-3 text-sm font-medium text-background transition-transform active:scale-95"
        >
          Back home
        </Link>
      </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "98 Studio — Web Design & SEO" },
      {
        name: "description",
        content:
          "An independent web design and SEO studio building editorial-grade brand sites and compounding organic growth programs.",
      },
    ...
    // The link must point to the imported URL variable
